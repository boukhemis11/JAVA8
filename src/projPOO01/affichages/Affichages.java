...
/**
 * Classe contien la method qui nous permettre de sisair est afficher les diffrents option de l'application
 * 
...
public class Affichages {
	...
	public static void Afficher() {
		...
		System.out.println("Taper 6 pour afficher le patron");
		...
		break;
		case 6 : AfficherCommun(Saisir.listsalarie);
		break;
		case 7 : Menus.Menu();
		break;
		default : Afficher();
